...
# ==============================================================================
# DEFINIÇÃO DOS FILTROS (MASCARAS 3x3)
# ==============================================================================
# Filtros pedidos: horizontal, vertical, 45, 135 e circular, alem de extras.
...
for caminho_imagem in imagens:
    ...
    # Lê a imagem e transforma de RGB para cinza
    img = cv2.imread(caminho_imagem, cv2.IMREAD_GRAYSCALE)
    if img is None:
        continue

    # Garante recortes de 512x512
    img = cv2.resize(img, (512, 512))

    # Piramide de 3 escalas
    escala1 = img
    ...
    for imagem_escala in lista_escalas:
        for matriz_filtro in filtros:
            # Aplica mascara (filtro espacial classico)
    ...
    # K-Means com distancia Euclidiana (padrao)
    numero_de_grupos = 4
